...
const Ruler = () => {
  ...
  return (
    <div ref={rulerRef} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} className='h-6 border-b border-gra-300 flex items-end relative select-none print:hidden'>
        <div
            id='ruler-container'
